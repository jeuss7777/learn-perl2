...
#
# perl Pr06_ScriptPerlGenerateLayerClasses.pl PathEntityClasses
#
# Example:
...
sub main {
	...
	if ( !(defined $warFile && length $warFile > 0)) {
    	...
    	$entityPath ='/home/jarana/eclipse-workspace/TemplateHibernate/src/main/java/com/jarana/entities';
	}
	...
	`cp $startDir/config/application.properties ../../../../../../src/main/resources/`;
	
	# Copying logback file
	`cp $startDir/config/logback.xml ../../../../../../src/main/resources/`;
